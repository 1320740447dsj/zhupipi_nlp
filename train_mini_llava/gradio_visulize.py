...
pretrain_model = AutoModelForCausalLM.from_pretrained('./dsj_mutimodel/pretrain/checkpoint-3000')
pretrain_model.to(device)

sft_model = AutoModelForCausalLM.from_pretrained('./dsj_mutimodel/sft/checkpoint-7440')
sft_model.to(device)
...
if __name__ == "__main__":
    demo.launch(share=True, server_name="127.0.0.1", server_port=7881)
